...
mine_melody = [
	notes['A4'], notes['B4'], notes['G4'], notes['E4'], notes['A4'], notes['A4'], notes['A4'],
	notes['E4'], notes['F4'], notes['E4'], notes['E4'], notes['D4'], notes['D4'], notes['D4'],
	
	notes['A4'], notes['B4'], notes['G4'], notes['F4'], notes['A4'], notes['A4'], notes['A4'],
	notes['E4'], notes['F4'], notes['E4'], notes['E4'], notes['D4'], notes['D4'], notes['D4'],
...
if __name__ == '__main__':		# Program start from here
	try:
		setup()
		print "Mine"
		play(mine_melody, mine_tempo, 0.50, 0.2)
		time.sleep(2)
